...
/**
 * From DroidPersianCalendar project, https://github.com/ebraminio/DroidPersianCalendar/
 *
 * Abstract class representing a date. Instances of this class should be
 * mutable. Various getters and setters are provided so that date manipulation is
