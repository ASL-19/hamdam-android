...
public class ShapedArrayAdapter<String> extends ArrayAdapter<String> {
    ...
    public ShapedArrayAdapter(Context context, int resource, String[] objects) {
        ...
        padding = (int)getContext().getResources().getDimension(com.hamdam.hamdam.R.dimen.listPreferredItemPadding);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
            utils.setFontShapeAndGravity((TextView) view);
        }
        return view;
    }
