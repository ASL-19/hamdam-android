...
import com.github.ebraminio.droidpersiancalendar.adapters.ShapedArrayAdapter;
...
public class ShapedListDialog extends PreferenceDialogFragmentCompat {
    ...
    protected void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        int selectDialogLayout = com.hamdam.hamdam.R.layout.select_dialog_singlechoice_material;
