 ...
 * Note: this date system is not used in Hamdam. However, if others wish to use the
 * DroidPersianCalendar + Hamdam to implement other date systems,
 * extensive edge case testing and a refined date-setting method are advised.
*/
